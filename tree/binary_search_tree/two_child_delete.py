    ...
    def delete(self, data):
        ...
        # 경우 3: 지우려는 노드가 2개의 자식이 있을 때
            ...
            if successor is successor.parent.left_child:  # successor 노드가 어떤 부모 노드의 왼쪽 자식일 때
                successor.parent.left_child = successor.right_child  # successor 노드가 오른쪽 자식을 갖고 있거나 아예 자식이 없을 때
            else:  # successor 노드가 삭제하려는 노드의 바로 오른쪽 자식일 때
                successor.parent.right_child = successor.right_child  # successor 노드가 오른쪽 자식을 갖고 있거나 아예 자식이 없을 때
